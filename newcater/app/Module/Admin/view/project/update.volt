                        ...
                        <div class="tab-content">
                            <div class="p-3" id="home" role="tabpanel">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="withdraw_form">
                                    ...
                                    <div class="form-group row">
                                        <label for="target" class="col-sm-3 col-form-label text-right">Target Funding</label>
                                        <div class="col-md-9 col-sm-9">
                                            <input type="text" value="{{ object.target }}" class="form-control" readonly id="target">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="percent_consensus" class="col-sm-3 col-form-label text-right">Percent Consensus Withdraw</label>
                                        <div class="col-sm-9 col-md-9">
                                            <input type="text" value="{{ object.percent_consensus ? object.percent_consensus : '51' }}" class="form-control" name="percent_consensus" id="percent_consensus">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="percent_terminate" class="col-sm-3 col-form-label text-right">Percent Terminate</label>
                                        <div class="col-sm-9 col-md-9">
                                            <input type="text" value="{{ object.percent_terminate ? object.percent_terminate : '51' }}" class="form-control" name="percent_terminate" id="percent_terminate">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 col-sm-9">
                                            <button type="submit" id="save-project" class="btn btn-success"><i class="fa fa-save"></i> Save</button>
                                        </div>
                                    </div>
