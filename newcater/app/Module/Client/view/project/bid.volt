                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12 product__view__content">
                            <div class="content_product_detail">
                                ...
                                <div class="product__view__desc content-detail-block" style="font-size: 18px; color: #e01616; font-weight: 500;">
                                    <i class="fa fa-clock-o"></i> <span id="bid_countdown" data-date="{{ object.contribute_end_time }}"><span class="time_countdown">{{ date('m/d/Y', object.contribute_end_time) }}</span></span>
                                </div>
                                ...
                                <div class="product__quantity product__view__quantity content-detail-block" style="margin-bottom: 10px">
                                    <div class="product__price product__price__regular">
                                        <p class="mb-0" style="display:inline-block; margin-right: 10px; color: #515151">
                                            <b>Current value: <span id="price_bid">{{ object.highest_value ? object.highest_value : 0 }} </span> ETH </b>
                                        </p>
