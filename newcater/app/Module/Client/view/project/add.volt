                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control">
                                        {% for item in list_category %}
                                            <option value="{{ item.id }}" {{ data_post['category_id'] == item.id ? 'selected' : '' }}>{{ item.name }}</option>
                                        {% endfor %}
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="100" name="target" required value="{{ data_post['target'] }}" id="target">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="percent_approve" value="{{ data_post['percent_approve'] ? data_post['percent_approve'] : 51 }}" id="percent_approve">
