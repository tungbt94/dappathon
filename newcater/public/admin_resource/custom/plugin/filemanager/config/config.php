...
//session_start();
define('_ROOT_', (dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))));
if (!file_exists(_ROOT_ . "/uploads/fmses")) mkdir(_ROOT_ . "/uploads/fmses", 0777, true);
session_save_path(_ROOT_ . "/uploads/fmses");
...
//define('_ROOT_' , "/home/vietz.vn/public_html/public");
...
//    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']), ['off', 'no'])) ? 'https' : 'http') . '://' . "vietz.vn",
