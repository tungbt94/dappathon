...
function startApp(){
  ...
  setInterval(updateStateFromNetwork, 60000) // refresh after 60s
}
    ...
    h('section.container', [
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', [
          ...
          h('button.btn.btn-success', 'request 10 ether from faucet', {
            style: {
              margin: '4px',
            },
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', {
          ...
          state.transactions.map((txHash) => {
            return link('http://127.0.0.1:8000/#/transaction/${txHash}', txHash);
          })
        ))
      ]),
